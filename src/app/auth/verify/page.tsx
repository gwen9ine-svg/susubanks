    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="email-code" type="text" placeholder="123456" required />
        </div>
        <div className="space-y-2">
          <Label htmlFor="phone-code">Phone Verification Code</Label>
          <Input id="phone-code" type="text" placeholder="123456" required />
        </div>
        ...
        <div className="relative">
         ...
         <Button variant="secondary" className="w-full">Use authenticator app</Button>
      </CardContent>
